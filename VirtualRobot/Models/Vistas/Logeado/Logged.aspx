<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logged.aspx.cs" Inherits="VirtualRobot.Logged" %>
...
<body>
  ...
  <g id="Logged_Language" data-name="Logged Language" clip-path="url(#clip-Logged_Language)">
    ...
    <g id="Group_14" data-name="Group 14" transform="translate(-45)">
      ...
      <g id="Basic_User_Info" data-name="Basic User Info">
          ...
          <g id="Beta" transform="translate(0 197.05)" onclick="Beta()" style="cursor:pointer">
            ...
            <g id="Info" transform="translate(-1.057)">
              ...
              <g transform="matrix(1, 0, 0, 1, 11.06, -197.05)" filter="url(#Beta_Testing_Program)">
                <text id="Beta_Testing_Program-2" data-name="Beta Testing  Program" transform="translate(561.94 830.07)" fill="#fefefe" font-size="25" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-75.446" y="0" id="BetaT">Beta Testing </tspan><tspan x="-51.135" y="33" id="Program">Program</tspan></text>
              </g>
            </g>
          </g>
          <g id="Main_menu_Human_Profile" data-name="Main menu Human Profile">
            <g id="Security_Settings-2" data-name="Security Settings" transform="translate(413 589.24)">
              <g transform="matrix(1, 0, 0, 1, -403, -589.24)" filter="url(#Security_Settings)">
                <text id="Security_Settings-3" data-name="Security Settings" transform="translate(554.29 621.3)" fill="#454545" font-size="22" font-family="SegoeUI, Segoe UI"><a href="SecuritySettings.aspx"><tspan x="-80.54" y="0" id="Security">Security Settings</tspan></a></text>
              </g>
            ...
            <g id="General_Settings-2" data-name="General Settings" transform="translate(413 523.808)">
              <g transform="matrix(1, 0, 0, 1, -403, -523.81)" filter="url(#General_Settings)">
                <text id="General_Settings-3" data-name="General Settings" transform="translate(552.29 553.86)" fill="#454545" font-size="22" font-family="SegoeUI, Segoe UI"><a href="GeneralSettings.aspx"><tspan x="-79.46" y="0" id="General">General Settings</tspan></a></text>
              </g>
            ...
            <g id="Human_Profile-3" data-name="Human Profile" transform="translate(413 458.945)">
              <g transform="matrix(1, 0, 0, 1, -403, -458.94)" filter="url(#Human_Profile)">
                <text id="Human_Profile-4" data-name="Human Profile" transform="translate(542.29 488)" fill="#fb3865" font-size="22" font-family="SegoeUI, Segoe UI" text-decoration="underline"><tspan x="-69.298" y="0" id="Human">Human Profile</tspan></text>
              </g>
        ...
        <g id="Photo_Credentials" data-name="Photo Credentials" transform="translate(0 -10)">
          <text id="Number_ID" data-name="Number ID" transform="translate(565 429)" fill="#888" font-size="17" font-family="SegoeUI, Segoe UI"><tspan x="-41.438" y="0" id="Number">Number ID</tspan></text>
          <text id="Status" transform="translate(565 399)" fill="#454545" font-size="25" font-family="SegoeUI, Segoe UI"><tspan x="-33.447" y="0" id="Status">Status</tspan></text>
          <text id="USERNAME_ID-4" data-name="USERNAME ID" transform="translate(565 364)" fill="#454545" font-size="30" font-family="SegoeUI, Segoe UI"><tspan x="-95.405" y="0" id="USERNAME">USERNAME ID</tspan></text>
    ...
    <g id="Header">
      ...
      <text id="Äarika_Citizenship_Portal" data-name="Äarika Citizenship Portal" transform="translate(960 43)" fill="#5e5e5e" font-size="30" font-family="SegoeUI, Segoe UI"><tspan x="-159.712" y="0" id="Äarika">Äarika Citizenship Portal</tspan></text>
