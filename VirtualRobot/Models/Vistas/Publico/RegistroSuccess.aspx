<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroSuccess.aspx.cs" Inherits="VirtualRobot.RegistroSuccess" %>
...
<body>
  ...
  <defs>
    ...
    <filter id="LogoVR" x="895" y="866" width="130.315" height="88.519" filterUnits="userSpaceOnUse">
    ...
    <filter id="Path_2" x="879.5" y="680.5" width="161.775" height="59.687" filterUnits="userSpaceOnUse">
    ...
    <clipPath id="clip-Create_Account_Confirmation">
      <rect width="1920" height="1080"/>
    </clipPath>
  </defs>
  <g id="Create_Account_Confirmation" data-name="Create Account Confirmation" clip-path="url(#clip-Create_Account_Confirmation)">
    ...
    <g id="Continue_Btm" data-name="Continue Btm" transform="translate(884 683)" onclick="Home()" style="cursor:pointer">
      <g transform="matrix(1, 0, 0, 1, -884, -683)" filter="url(#Path_2)">
        <g id="Path_2-2" data-name="Path 2" transform="translate(884 683)" fill="url(#linear-gradient)">
      ...
      <text id="Log_In" data-name="Log In" transform="translate(76 33)" fill="#fff" font-size="19" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-27.925" y="0" >Log In</tspan></text>
    </g>
    <text id="Welcome_to_Äarika_Portal_Human_We_just_sent_you_an_email_with_your_credentials_to_the_Äarika_Portal_and_a_confirmation_link_so_you_can_validate_your_E-Mail_Address._" data-name="Welcome to Äarika Portal Human!  We just sent you an email with your credentials to the Äarika Portal and a confirmation link so you can validate your  E-Mail Address. " transform="translate(960 423)" fill="#454545" font-size="40" font-family="SegoeUI, Segoe UI"><tspan x="-298.096" y="0" id="Welcome">Welcome to Äarika Portal Human!</tspan><tspan x="0" y="53"/><tspan font-size="25"><tspan x="-368.555" y="90" id="We">We just sent you an email with your credentials to the Äarika Portal</tspan><tspan x="-267.529" y="123" id="and">and a confirmation link so you can validate your </tspan><tspan x="-88.794" y="156" id="E-Mail">E-Mail Address. </tspan></tspan></text>
...
<script>
    ...
    function Idioma() {
        ...
        if (idioma == null) {
            ...
            if (idioma == "Español") {
                document.getElementById("Welcome").innerHTML = "Bienvenido al portal de Äarika Humano!";
                document.getElementById("We").innerHTML = "Te acabamos de enviar un correo con tus credenciales para el portal de Äarika";
                document.getElementById("and").innerHTML = "y un link de confirmacion para que puedas validar";
                document.getElementById("E-Mail").innerHTML = "tu direccionn de correo";
            } else {
                document.getElementById("Welcome").innerHTML = "Welcome to Äarika Portal Human!";
                document.getElementById("We").innerHTML = "We just sent you an email with your credentials to the Äarika Portal";
                document.getElementById("and").innerHTML = "and a confirmation link so you can validate your";
                document.getElementById("E-Mail").innerHTML = "E-Mail Address.";
            }
        }
    }
    function English() {
