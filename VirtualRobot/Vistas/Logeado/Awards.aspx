<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Logged.Master" AutoEventWireup="true" CodeBehind="Awards.aspx.cs" Inherits="VirtualRobot.Vistas.Logeado.Awards" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <defs>
    ...
    <filter id="Path_30" x="1506.358" y="240.212" width="15.283" height="71" filterUnits="userSpaceOnUse">
    ...
    <filter id="Path_46" x="763.398" y="298" width="23.786" height="24.796" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_47" x="768.32" y="301.92" width="13.941" height="13.942" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_48" x="770.419" y="304.009" width="9.745" height="9.563" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_46-2" x="763.398" y="335" width="23.786" height="24.796" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_47-2" x="768.32" y="338.92" width="13.941" height="13.942" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_48-2" x="770.419" y="341.009" width="9.745" height="9.563" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_46-3" x="763.398" y="261" width="23.786" height="24.796" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_47-3" x="768.32" y="264.92" width="13.941" height="13.942" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
    ...
    <filter id="Path_48-3" x="770.419" y="267.009" width="9.745" height="9.563" filterUnits="userSpaceOnUse">
      <feOffset dy="2" input="SourceAlpha"/>
  ...
  <g id="Awards" clip-path="url(#clip-Awards)">
    ...
    <g id="Footer">
      ...
      <text id="Terms_of_Use_Privacy_Policy" data-name="Terms of Use | Privacy Policy" transform="translate(1466 1065)" fill="#f9a01b" font-size="18" font-family="SegoeUI, Segoe UI"><a href="../Publico/Login.aspx"><tspan x="0" y="0">Terms of Use </tspan></a><tspan y="0" fill="#454545" font-size="22">|</tspan><a href="Login.aspx"><tspan y="0" xml:space="preserve"> Privacy Policy</tspan></a></text>
    ...
    <g id="Group_14" data-name="Group 14" transform="translate(-45)">
      <g id="InfoBG" transform="translate(-108.152 44.613)">
        ...
        <g id="Scroll" transform="translate(918.152 124.599)">
          <rect id="Rectangle_32" data-name="Rectangle 32" width="9.283" height="730.973" rx="4.642" transform="translate(744.358 72)" fill="#cecece"/>
          <g transform="matrix(1, 0, 0, 1, -765, -169.21)" filter="url(#Path_30)">
            <path id="Path_30-2" data-name="Path 30" d="M4.642,0A4.642,4.642,0,0,1,9.283,4.642V60.358a4.642,4.642,0,0,1-9.283,0V4.642A4.642,4.642,0,0,1,4.642,0Z" transform="translate(1509.36 241.21)" fill="#5a7a9b"/>
          </g>
        </g>
      </g>
      <g id="Awards-2" data-name="Awards" transform="translate(810 710)">
        <g id="Eolas" transform="translate(0 37)">
          <g id="Beta" transform="translate(-4.418 -453.233)">
            <g id="trophy" transform="translate(5.817 5.233)">
              <g transform="matrix(1, 0, 0, 1, -766.4, -299)" filter="url(#Path_46)">
                <path id="Path_46-4" data-name="Path 46" d="M28.607,7.458V1.1H29.8V0H15.507V1.1H16.7V7.458H13.759v.551a8.9,8.9,0,0,0,6.651,8.609l-.159,1.077h-.816v1.1h6.434v-1.1h-.816L24.891,16.6A9.671,9.671,0,0,0,28.94,14.3a8.835,8.835,0,0,0,2.6-6.288V7.458H28.607ZM27.505,1.1V8.009a4.853,4.853,0,0,1-9.706,0V1.1ZM17.143,13.518A7.733,7.733,0,0,1,14.88,8.56h1.843a5.969,5.969,0,0,0,4.122,5.123l-.272,1.838A7.75,7.75,0,0,1,17.143,13.518Zm4.222,4.177.559-3.775a5.971,5.971,0,0,0,1.457,0l.559,3.775Zm6.8-4.177A8.622,8.622,0,0,1,24.728,15.5l-.269-1.818A5.969,5.969,0,0,0,28.581,8.56h1.843A7.733,7.733,0,0,1,28.161,13.518Z" transform="translate(752.64 299)" fill="#707070"/>
              </g>
              <g transform="matrix(1, 0, 0, 1, -766.4, -299)" filter="url(#Path_47)">
                <path id="Path_47-4" data-name="Path 47" d="M148.976,113.56a3.972,3.972,0,1,0-1.163-2.808A3.959,3.959,0,0,0,148.976,113.56Zm.779-4.838a2.87,2.87,0,1,1-.841,2.029A2.851,2.851,0,0,1,149.755,108.722Z" transform="translate(623.51 196.14)" fill="#707070"/>
              </g>
              <g transform="matrix(1, 0, 0, 1, -766.4, -299)" filter="url(#Path_48)">
                <path id="Path_48-4" data-name="Path 48" d="M205.7,167.247l1.158-.485,1.158.485-.1-1.251.819-.951-1.221-.288-.652-1.072-.652,1.072-1.221.288.819.951Z" transform="translate(568.44 141.33)" fill="#707070"/>
              </g>
            </g>
          </g>
          <text id="Got_your_first_000_Eolas" data-name="Got your first #000 Eolas" transform="translate(48 -431)" fill="#454545" font-size="22" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Got your first #000 Eolas</tspan></text>
        </g>
        <g id="Eolas-2" data-name="Eolas" transform="translate(0 74)">
          <g id="Beta-2" data-name="Beta" transform="translate(-4.418 -453.233)">
            <g id="trophy-2" data-name="trophy" transform="translate(5.817 5.233)">
              <g transform="matrix(1, 0, 0, 1, -766.4, -336)" filter="url(#Path_46-2)">
                <path id="Path_46-5" data-name="Path 46" d="M28.607,7.458V1.1H29.8V0H15.507V1.1H16.7V7.458H13.759v.551a8.9,8.9,0,0,0,6.651,8.609l-.159,1.077h-.816v1.1h6.434v-1.1h-.816L24.891,16.6A9.671,9.671,0,0,0,28.94,14.3a8.835,8.835,0,0,0,2.6-6.288V7.458H28.607ZM27.505,1.1V8.009a4.853,4.853,0,0,1-9.706,0V1.1ZM17.143,13.518A7.733,7.733,0,0,1,14.88,8.56h1.843a5.969,5.969,0,0,0,4.122,5.123l-.272,1.838A7.75,7.75,0,0,1,17.143,13.518Zm4.222,4.177.559-3.775a5.971,5.971,0,0,0,1.457,0l.559,3.775Zm6.8-4.177A8.622,8.622,0,0,1,24.728,15.5l-.269-1.818A5.969,5.969,0,0,0,28.581,8.56h1.843A7.733,7.733,0,0,1,28.161,13.518Z" transform="translate(752.64 336)" fill="#707070"/>
              </g>
              <g transform="matrix(1, 0, 0, 1, -766.4, -336)" filter="url(#Path_47-2)">
                <path id="Path_47-5" data-name="Path 47" d="M148.976,113.56a3.972,3.972,0,1,0-1.163-2.808A3.959,3.959,0,0,0,148.976,113.56Zm.779-4.838a2.87,2.87,0,1,1-.841,2.029A2.851,2.851,0,0,1,149.755,108.722Z" transform="translate(623.51 233.14)" fill="#707070"/>
              </g>
              <g transform="matrix(1, 0, 0, 1, -766.4, -336)" filter="url(#Path_48-2)">
                <path id="Path_48-5" data-name="Path 48" d="M205.7,167.247l1.158-.485,1.158.485-.1-1.251.819-.951-1.221-.288-.652-1.072-.652,1.072-1.221.288.819.951Z" transform="translate(568.44 178.33)" fill="#707070"/>
              </g>
            </g>
          </g>
          <text id="Got_the_Inspector_Status" data-name="Got the &quot;Inspector&quot; Status" transform="translate(48 -431)" fill="#454545" font-size="22" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Got the "Inspector" Status</tspan></text>
        </g>
        <g id="BetaTesting">
          <g id="Beta-3" data-name="Beta" transform="translate(-4.418 -453.233)">
            <g id="trophy-3" data-name="trophy" transform="translate(5.817 5.233)">
              <g transform="matrix(1, 0, 0, 1, -766.4, -262)" filter="url(#Path_46-3)">
                <path id="Path_46-6" data-name="Path 46" d="M28.607,7.458V1.1H29.8V0H15.507V1.1H16.7V7.458H13.759v.551a8.9,8.9,0,0,0,6.651,8.609l-.159,1.077h-.816v1.1h6.434v-1.1h-.816L24.891,16.6A9.671,9.671,0,0,0,28.94,14.3a8.835,8.835,0,0,0,2.6-6.288V7.458H28.607ZM27.505,1.1V8.009a4.853,4.853,0,0,1-9.706,0V1.1ZM17.143,13.518A7.733,7.733,0,0,1,14.88,8.56h1.843a5.969,5.969,0,0,0,4.122,5.123l-.272,1.838A7.75,7.75,0,0,1,17.143,13.518Zm4.222,4.177.559-3.775a5.971,5.971,0,0,0,1.457,0l.559,3.775Zm6.8-4.177A8.622,8.622,0,0,1,24.728,15.5l-.269-1.818A5.969,5.969,0,0,0,28.581,8.56h1.843A7.733,7.733,0,0,1,28.161,13.518Z" transform="translate(752.64 262)" fill="#707070"/>
              </g>
              <g transform="matrix(1, 0, 0, 1, -766.4, -262)" filter="url(#Path_47-3)">
                <path id="Path_47-6" data-name="Path 47" d="M148.976,113.56a3.972,3.972,0,1,0-1.163-2.808A3.959,3.959,0,0,0,148.976,113.56Zm.779-4.838a2.87,2.87,0,1,1-.841,2.029A2.851,2.851,0,0,1,149.755,108.722Z" transform="translate(623.51 159.14)" fill="#707070"/>
              </g>
              <g transform="matrix(1, 0, 0, 1, -766.4, -262)" filter="url(#Path_48-3)">
                <path id="Path_48-6" data-name="Path 48" d="M205.7,167.247l1.158-.485,1.158.485-.1-1.251.819-.951-1.221-.288-.652-1.072-.652,1.072-1.221.288.819.951Z" transform="translate(568.44 104.33)" fill="#707070"/>
              </g>
            </g>
          </g>
          <text id="Successfully_Joined_the_Beta_Testing_Program" data-name="Successfully Joined the Beta Testing Program" transform="translate(48 -431)" fill="#454545" font-size="22" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Successfully Joined the Beta Testing Program</tspan></text>
        </g>
      </g>
      <text id="Notifications" transform="translate(799 177)" fill="#454545" font-size="35" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="0" y="0">Notifications</tspan></text>
      <g id="Basic_User_Info" data-name="Basic User Info">
        ...
        <g id="Menu" transform="translate(35)">
          <g id="Beta-4" data-name="Beta" transform="translate(0 197.05)" onclick="Beta()" style="cursor:pointer">
            <g transform="matrix(1, 0, 0, 1, 10, -197.05)" filter="url(#BG)">
              <rect id="BG-2" data-name="BG" width="281" height="91.901" rx="25" transform="translate(379 790.05)" fill="url(#linear-gradient)"/>
            </g>
          ...
          <g id="Main_menu_Notifications" data-name="Main menu Notifications">
