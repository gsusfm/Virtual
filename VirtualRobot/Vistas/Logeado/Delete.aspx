<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="VirtualRobot.Delete" %>
...
<body>
  ...
  <defs>
    ...
    <filter id="Rectangle_14" x="708" y="96" width="841.074" height="913.86" filterUnits="userSpaceOnUse">
    ...
    <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
      ...
      <stop offset="1" stop-color="#fa7d5e"/>
    </linearGradient>
    <filter id="Rectangle_34" x="1110.463" y="911.5" width="162.9" height="47" filterUnits="userSpaceOnUse">
    ...
    <filter id="Delete_Account" x="1126.685" y="920.867" width="130" height="28" filterUnits="userSpaceOnUse">
    ...
    <linearGradient id="linear-gradient-2" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color="#007d81"/>
      <stop offset="1" stop-color="#807cff"/>
    </linearGradient>
    <filter id="Rectangle_27" x="984.5" y="911.5" width="110" height="47" filterUnits="userSpaceOnUse">
      <feOffset dy="1" input="SourceAlpha"/>
    ...
    <filter id="Back" x="1016.5" y="919.5" width="47" height="29" filterUnits="userSpaceOnUse">
      <feOffset dy="1" input="SourceAlpha"/>
    ...
    <clipPath id="clip-General_Settings_Delete_Account">
      <rect width="1920" height="1080"/>
    </clipPath>
  </defs>
  <g id="General_Settings_Delete_Account" data-name="General Settings Delete Account" clip-path="url(#clip-General_Settings_Delete_Account)">
    ...
    <g id="Group_14" data-name="Group 14" transform="translate(-45)">
      <g id="InfoBG" transform="translate(-108.152 44.613)">
        <g transform="matrix(1, 0, 0, 1, 153.15, -44.61)" filter="url(#Rectangle_14)">
          <rect id="Rectangle_14-2" data-name="Rectangle 14" width="823.074" height="895.86" rx="25" transform="translate(717 102)" fill="#fff"/>
        </g>
        <path id="Rectangle_9" data-name="Rectangle 9" d="M0,0H808.791a0,0,0,0,1,0,0V735.929a23,23,0,0,1-23,23H23a23,23,0,0,1-23-23V0A0,0,0,0,1,0,0Z" transform="translate(877.294 183.283)" fill="#f5f5f5"/>
      </g>
      <g id="Text" transform="translate(0 -8)">
        <text id="Deletion_of_this_account_will_result_in_loss_of_ALL_content_associated_with_it_which_may_include_the_following:_Any_existing_funds_usable_through_this_account_Software_and_items_purchased_via_this_Virtual_Robot_Account_T" data-name="Deletion of this account will result in loss of ALL content associated with it, which may include the following:             Any existing funds usable through this account            Software, and items purchased via this Virtual Robot Account            T" transform="translate(833 381)" fill="#454545" font-size="17" font-family="SegoeUI, Segoe UI"><tspan x="0" y="18">Deletion of this account will result in loss of ALL content associated with it, which may </tspan><tspan x="0" y="40">include the following:</tspan><tspan x="0" y="62"/><tspan x="0" y="84"/><tspan x="0" y="106" xml:space="preserve">          </tspan><tspan y="106" font-size="15">Any existing funds usable through this account</tspan><tspan font-size="15"><tspan x="0" y="126" xml:space="preserve">           Software, and items purchased via this Virtual Robot Account</tspan><tspan x="0" y="146" xml:space="preserve">           The ability to redownload any digital software purchased by / linked to this account</tspan><tspan x="0" y="166" xml:space="preserve">           Save/user data of any apps linked to this account</tspan></tspan><tspan font-size="15" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="0" y="186"/></tspan><tspan font-size="20" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="0" y="212"/><tspan x="0" y="239">What is our process for account deletion</tspan><tspan y="239" font-size="17" font-family="SegoeUI, Segoe UI" font-weight="400">?</tspan></tspan><tspan x="0" y="262"/><tspan x="0" y="284">After choosing to delete a Virtual Robot Account, it will be deactivated for 15 days before </tspan><tspan x="0" y="306">being deleted, during which time you can reactivate it by attempting to sign in. The </tspan><tspan x="0" y="328">account will be deleted permanently after the deactivation period passes.</tspan><tspan x="0" y="350"/><tspan x="0" y="372">To reactivate an account that has been set for deletion, you need the password and e-mail </tspan><tspan x="0" y="394">address you use to sign in to your account. If you haven't verified your e-mail address, you </tspan><tspan x="0" y="416">won't be able to retrieve your password if you forget it. Please verify your e-mail address in </tspan><tspan x="0" y="438">case you want to reactivate this account.</tspan><tspan x="0" y="460"/><tspan x="0" y="482">If you choose to reactivate an account during the deactivation period, we cannot </tspan><tspan x="0" y="504">guarantee that all of the data will be recovered.</tspan></text>
        <g id="Dots" transform="translate(0 31)">
          <circle id="Ellipse_6" data-name="Ellipse 6" cx="4.5" cy="4.5" r="4.5" transform="translate(851 436)"/>
          <circle id="Ellipse_7" data-name="Ellipse 7" cx="4.5" cy="4.5" r="4.5" transform="translate(851 454.085)"/>
          <circle id="Ellipse_8" data-name="Ellipse 8" cx="4.5" cy="4.5" r="4.5" transform="translate(851 472.521)"/>
          <circle id="Ellipse_9" data-name="Ellipse 9" cx="4.5" cy="4.5" r="4.5" transform="translate(851 490.605)"/>
        </g>
        <text id="Attention_By_clicking_Delete_Account_below_you_will_start_the_process_of_deleting_your_Virtual_Robot_Account." data-name="Attention! By clicking &quot;Delete Account&quot; below, you will start the process of deleting your Virtual Robot Account." transform="translate(833 273)" fill="#fb3865" font-size="20" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="1.352" y="22">Attention! By clicking "Delete Account" below, you will start the process </tspan><tspan x="155.17" y="49">of deleting your Virtual Robot Account.</tspan></text>
      </g>
      <g id="Buttons" transform="translate(62.413 80)">
        <g id="CancelAccount" transform="translate(1012.55 896)" onclick="Delete()" style="cursor:pointer">
          <g transform="matrix(1, 0, 0, 1, -1029.96, -976)" filter="url(#Rectangle_34)">
            <g id="Rectangle_34-2" data-name="Rectangle 34" transform="translate(1114.96 915)" stroke="#f94f1b" stroke-width="3" fill="url(#linear-gradient)">
              <rect width="153.9" height="38" rx="16" stroke="none"/>
              <rect x="1.5" y="1.5" width="150.9" height="35" rx="14.5" fill="none"/>
            </g>
          </g>
          <g transform="matrix(1, 0, 0, 1, -1029.96, -976)" filter="url(#Delete_Account)">
            <text id="Delete_Account-2" data-name="Delete Account" transform="translate(1191.68 939.87)" fill="#fff" font-size="17" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-61.023" y="0">Delete Account</tspan></text>
          </g>
        </g>
        <g id="BackBtm" transform="translate(864.587 825)" onclick="Back()" style="cursor:pointer">
          <g transform="matrix(1, 0, 0, 1, -882, -905)" filter="url(#Rectangle_27)">
            <g id="Rectangle_27-2" data-name="Rectangle 27" transform="translate(989 915)" stroke="#0973fe" stroke-width="3" fill="url(#linear-gradient-2)">
              <rect width="101" height="38" rx="16" stroke="none"/>
              <rect x="1.5" y="1.5" width="98" height="35" rx="14.5" fill="none"/>
            </g>
          </g>
          <g transform="matrix(1, 0, 0, 1, -882, -905)" filter="url(#Back)">
            <text id="Back-2" data-name="Back" transform="translate(1040 941)" fill="#fff" font-size="19" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-21.073" y="0">Back</tspan></text>
          </g>
        </g>
      </g>
      <text id="General_Settings-2" data-name="General Settings" transform="translate(799 177)" fill="#454545" font-size="35" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="0" y="0">General Settings</tspan></text>
        ...
        <g id="Menu" transform="translate(35)">
          <g id="Beta" transform="translate(0 197.05)" onclick="Beta()" style="cursor:pointer">
            <g transform="matrix(1, 0, 0, 1, 10, -197.05)" filter="url(#BG)">
              <rect id="BG-2" data-name="BG" width="281" height="91.901" rx="25" transform="translate(379 790.05)" fill="url(#linear-gradient-3)"/>
            </g>
          ...
          <g id="Main_menu_General_Settings" data-name="Main menu General Settings">
            ...
            <g id="General_Settings-3" data-name="General Settings" transform="translate(413 523.808)">
              <g transform="matrix(1, 0, 0, 1, -403, -523.81)" filter="url(#General_Settings)">
                <text id="General_Settings-4" data-name="General Settings" transform="translate(552.29 553.86)" fill="#fb3865" font-size="22" font-family="SegoeUI, Segoe UI" text-decoration="underline"><tspan x="-79.46" y="0">General Settings</tspan></text>
              </g>
            ...
            <g id="Human_Profile-2" data-name="Human Profile" transform="translate(413 458.945)">
              <g transform="matrix(1, 0, 0, 1, -403, -458.94)" filter="url(#Human_Profile)">
                <text id="Human_Profile-3" data-name="Human Profile" transform="translate(472.29 488)" fill="#454545" font-size="22" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Human Profile</tspan></text>
              </g>
...
<script>
    ...
    function Delete() {
        location.replace("../Publico/DeleteSuccess.aspx")
    }
    function Back() {
        location.replace("GeneralSettings.aspx")
    }
    function UserHover() {
