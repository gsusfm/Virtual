<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralSettings.aspx.cs" Inherits="VirtualRobot.GeneralSettings2" %>
...
<body>
  ...
  <defs>
    ...
    <filter id="Rectangle_14" x="708" y="96" width="841.074" height="420.86" filterUnits="userSpaceOnUse">
    ...
    <filter id="Rectangle_34" x="1012.5" y="400.065" width="198.826" height="55.871" filterUnits="userSpaceOnUse">
    ...
    <filter id="Delete_Account" x="1033.092" y="410.501" width="158" height="34" filterUnits="userSpaceOnUse">
    ...
    <clipPath id="clip-General_Settings-2">
      <rect width="1920" height="1080"/>
    </clipPath>
  </defs>
  <g id="General_Settings-2" data-name="General Settings" clip-path="url(#clip-General_Settings-2)">
    ...
    <g id="Group_14" data-name="Group 14" transform="translate(-45)">
      <g id="InfoBG" transform="translate(-108.152 44.613)">
        <g transform="matrix(1, 0, 0, 1, 153.15, -44.61)" filter="url(#Rectangle_14)">
          <rect id="Rectangle_14-2" data-name="Rectangle 14" width="823.074" height="402.86" rx="25" transform="translate(717 102)" fill="#fff"/>
        </g>
        <path id="Rectangle_9" data-name="Rectangle 9" d="M0,0H808.791a0,0,0,0,1,0,0V245.929a23,23,0,0,1-23,23H23a23,23,0,0,1-23-23V0A0,0,0,0,1,0,0Z" transform="translate(877.294 183.283)" fill="#f5f5f5"/>
      </g>
      <g id="Buttons" transform="translate(-17.587 -427)">
        <g id="CancelAccount" transform="translate(994.587 891.565)" onclick="Delete()" style="cursor:pointer">
          <g transform="matrix(1, 0, 0, 1, -932, -464.56)" filter="url(#Rectangle_34)">
            <g id="Rectangle_34-2" data-name="Rectangle 34" transform="translate(1017 403.56)" stroke="#f94f1b" stroke-width="3" fill="url(#linear-gradient)">
              <rect width="189.826" height="46.871" rx="23.435" stroke="none"/>
              <rect x="1.5" y="1.5" width="186.826" height="43.871" rx="21.935" fill="none"/>
            </g>
          </g>
          <g transform="matrix(1, 0, 0, 1, -932, -464.56)" filter="url(#Delete_Account)">
            <text id="Delete_Account-2" data-name="Delete Account" transform="translate(1112.09 434.5)" fill="#fff" font-size="21" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-75.382" y="0">Delete Account</tspan></text>
          </g>
        </g>
      </g>
      <g id="Promotions" transform="translate(0 -108)">
        <g id="Rectangle_33" data-name="Rectangle 33" transform="translate(813 412)" fill="#fff" stroke="#707070" stroke-width="1">
          <rect width="27" height="27" rx="7" stroke="none"/>
          <rect x="0.5" y="0.5" width="26" height="26" rx="6.5" fill="none"/>
        </g>
        <text id="I_would_like_to_receive_promotional_and_informative_email_from_Virtual_Robot." data-name="I would like to receive promotional and informative email from Virtual Robot." transform="translate(868 432)" fill="#454545" font-size="17" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">I would like to receive promotional and informative email from Virtual Robot.</tspan></text>
      </g>
      <text id="General_Settings-3" data-name="General Settings" transform="translate(799 177)" fill="#454545" font-size="35" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="0" y="0">General Settings</tspan></text>
      <g id="Basic_User_Info" data-name="Basic User Info">
        ...
        <g id="Menu" transform="translate(35)">
          ...
          <g id="Main_menu_General_Settings" data-name="Main menu General Settings">
            ...
            <g id="General_Settings-4" data-name="General Settings" transform="translate(413 523.808)">
              <g transform="matrix(1, 0, 0, 1, -403, -523.81)" filter="url(#General_Settings)">
                <text id="General_Settings-5" data-name="General Settings" transform="translate(552.29 553.86)" fill="#fb3865" font-size="22" font-family="SegoeUI, Segoe UI" text-decoration="underline"><tspan x="-79.46" y="0">General Settings</tspan></text>
              </g>
