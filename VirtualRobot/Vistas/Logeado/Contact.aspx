<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="VirtualRobot.Contact" %>
...
<body>
  ...
  <defs>
    ...
    <filter id="Rectangle_27" x="1084.5" y="912.5" width="88" height="47" filterUnits="userSpaceOnUse">
    ...
    <filter id="SEND" x="1102.5" y="920.5" width="53" height="29" filterUnits="userSpaceOnUse">
      <feOffset dy="1" input="SourceAlpha"/>
    ...
    <filter id="Path_22-2" x="414.357" y="818.31" width="30.205" height="38.063" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <filter id="Ellipse_4-2" x="398.5" y="587.74" width="57.582" height="57.581" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <filter id="Path_22-3" x="412.914" y="596.276" width="29.189" height="36.808" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <filter id="Ellipse_4-3" x="398.5" y="522.308" width="57.582" height="57.581" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <filter id="Path_22-4" x="412.914" y="530.844" width="29.189" height="36.808" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <filter id="Ellipse_4-4" x="398.5" y="457.445" width="57.582" height="57.581" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <filter id="Path_22-5" x="412.914" y="465.98" width="29.189" height="36.808" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <clipPath id="clip-Contact_Form">
      <rect width="1920" height="1080"/>
    </clipPath>
  </defs>
  <g id="Contact_Form" data-name="Contact Form" clip-path="url(#clip-Contact_Form)">
    ...
    <g id="Group_14" data-name="Group 14" transform="translate(-45)">
      ...
      <g id="Buttons" transform="translate(0 17)">
        <g id="Edit_Btm" data-name="Edit Btm" transform="translate(1022 889)" onclick="Send()" style="cursor:pointer">
          <g transform="matrix(1, 0, 0, 1, -977, -906)" filter="url(#Rectangle_27)">
            <g id="Rectangle_27-2" data-name="Rectangle 27" transform="translate(1089 916)" stroke="#f9a01b" stroke-width="3" fill="url(#linear-gradient)">
              <rect width="79" height="38" rx="16" stroke="none"/>
              <rect x="1.5" y="1.5" width="76" height="35" rx="14.5" fill="none"/>
            </g>
          </g>
          <g transform="matrix(1, 0, 0, 1, -977, -906)" filter="url(#SEND)">
            <text id="SEND-2" data-name="SEND" transform="translate(1129 942)" fill="#fff" font-size="19" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-24.891" y="0">SEND</tspan></text>
          </g>
        </g>
      </g>
      <g id="Form" transform="translate(880 312.702)">
        <g id="ShortDescription" transform="translate(-70 122)">
          <g id="Rectangle_37" data-name="Rectangle 37" transform="translate(0 32)" fill="#fff" stroke="#707070" stroke-width="1">
            <rect width="727" height="410.298" rx="15" stroke="none"/>
            <rect x="0.5" y="0.5" width="726" height="409.298" rx="14.5" fill="none"/>
          </g>
          <text id="Full_Description:" data-name="Full Description:" transform="translate(0 15)" fill="#3c3c3c" font-size="16" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Full Description:</tspan></text>
        </g>
        <g id="ShortDescription-2" data-name="ShortDescription" transform="translate(-70 30)">
          <g id="Rectangle_37-2" data-name="Rectangle 37" transform="translate(0 32)" fill="#fff" stroke="#707070" stroke-width="1">
            <rect width="727" height="40" rx="10" stroke="none"/>
            <rect x="0.5" y="0.5" width="726" height="39" rx="9.5" fill="none"/>
          </g>
          <text id="Short_Description:" data-name="Short Description:" transform="translate(0 15)" fill="#3c3c3c" font-size="16" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Short Description:</tspan></text>
        </g>
        <g id="E-MailAddress" transform="translate(-70 -9)">
          ...
          <text id="E-Mail_Address" data-name="E-Mail Address" transform="translate(181 15)" fill="#7a7a7a" font-size="16" font-family="SegoeUI, Segoe UI"><tspan x="-52.902" y="0">E-Mail Address</tspan></text>
        </g>
        <g id="Username_ID" data-name="Username ID" transform="translate(-70 -48)">
          <text id="From:" transform="translate(0 15)" fill="#3c3c3c" font-size="16" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">From:</tspan></text>
          <text id="Username_ID-2" data-name="Username ID" transform="translate(100 15)" fill="#7a7a7a" font-size="16" font-family="SegoeUI, Segoe UI"><tspan x="-45.457" y="0">Username ID</tspan></text>
        </g>
      </g>
      <text id="Contact_Us" data-name="Contact Us" transform="translate(799 177)" fill="#454545" font-size="35" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="0" y="0">Contact Us</tspan></text>
      <g id="Basic_User_Info" data-name="Basic User Info">
        ...
        <g id="Photo_Credentials" data-name="Photo Credentials" transform="translate(0 -10)">
          ...
          <text id="USERNAME_ID-3" data-name="USERNAME ID" transform="translate(565 364)" fill="#454545" font-size="30" font-family="SegoeUI, Segoe UI"><tspan x="-95.405" y="0">USERNAME ID</tspan></text>
...
<script>
    ...
    function Send() {
        location.replace("ContactSuccess.aspx")
    }
    function UserHover() {
