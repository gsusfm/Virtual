<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BetaDNA.aspx.cs" Inherits="VirtualRobot.BetaDNA" %>
...
<body>
  ...
  <defs>
    ...
    <filter id="Path_30" x="1506.359" y="242.494" width="15.283" height="71" filterUnits="userSpaceOnUse">
    ...
    <filter id="Rectangle_35" x="1063.5" y="908.5" width="274" height="52" filterUnits="userSpaceOnUse">
    ...
    <filter id="Join_Beta_Testing_Program_" x="1078.5" y="917.5" width="245" height="29" filterUnits="userSpaceOnUse">
      <feOffset dy="1" input="SourceAlpha"/>
    ...
    <filter id="Rectangle_27" x="919.5" y="910.5" width="114" height="49" filterUnits="userSpaceOnUse">
      <feOffset dy="1" input="SourceAlpha"/>
    ...
    <filter id="CANCEL" x="939.5" y="919.5" width="75" height="29" filterUnits="userSpaceOnUse">
      <feOffset dy="1" input="SourceAlpha"/>
    ...
    <clipPath id="clip-Beta_Testing_DNA">
      <rect width="1920" height="1080"/>
    </clipPath>
  </defs>
  <g id="Beta_Testing_DNA" data-name="Beta Testing DNA" clip-path="url(#clip-Beta_Testing_DNA)">
    ...
    <g id="Group_14" data-name="Group 14" transform="translate(-45)">
      <rect id="Rectangle_5" data-name="Rectangle 5" width="1920" height="1080" transform="translate(45)" fill="#f5f5f5"/>
      <g id="InfoBG" transform="translate(-108.152 44.613)">
        ...
        <rect id="Rectangle_9" data-name="Rectangle 9" width="808.791" height="593.238" transform="translate(877.294 183.283)" fill="#f5f5f5"/>
        <g id="Scroll" transform="translate(918.152 126.881)">
          <rect id="Rectangle_32" data-name="Rectangle 32" width="9.283" height="565.23" rx="4.642" transform="translate(744.358 72)" fill="#cecece"/>
          <g transform="matrix(1, 0, 0, 1, -765, -171.49)" filter="url(#Path_30)">
            <path id="Path_30-2" data-name="Path 30" d="M4.642,0A4.642,4.642,0,0,1,9.283,4.642V60.358a4.642,4.642,0,0,1-9.283,0V4.642A4.642,4.642,0,0,1,4.642,0Z" transform="translate(1509.36 243.49)" fill="#5a7a9b"/>
          </g>
        </g>
      </g>
      <g id="Buttons" transform="translate(-90)">
        <g id="JoinBetaBtm" transform="translate(1181 903)" onclick="Join()" style="cursor:pointer">
          <g transform="matrix(1, 0, 0, 1, -1046, -903)" filter="url(#Rectangle_35)">
            <g id="Rectangle_35-2" data-name="Rectangle 35" transform="translate(1068 912)" stroke="#8600ef" stroke-width="3" fill="url(#linear-gradient)">
              <rect width="265" height="43" rx="16" stroke="none"/>
              <rect x="1.5" y="1.5" width="262" height="40" rx="14.5" fill="none"/>
            </g>
          </g>
          <g transform="matrix(1, 0, 0, 1, -1046, -903)" filter="url(#Join_Beta_Testing_Program_)">
            <text id="Join_Beta_Testing_Program_2" data-name="Join Beta Testing Program!" transform="translate(1201 939)" fill="#fff" font-size="19" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-120.415" y="0">Join Beta Testing Program!</tspan></text>
          </g>
        </g>
        <g id="Cancel_Btm" data-name="Cancel Btm" transform="translate(954 905)" onclick="  Back()" style="cursor:pointer">
          <g transform="matrix(1, 0, 0, 1, -819, -905)" filter="url(#Rectangle_27)">
            <g id="Rectangle_27-2" data-name="Rectangle 27" transform="translate(924 914)" stroke="#fe3209" stroke-width="3" fill="url(#linear-gradient-2)">
              <rect width="105" height="40" rx="16" stroke="none"/>
              <rect x="1.5" y="1.5" width="102" height="37" rx="14.5" fill="none"/>
            </g>
          </g>
          <g transform="matrix(1, 0, 0, 1, -819, -905)" filter="url(#CANCEL)">
            <text id="CANCEL-2" data-name="CANCEL" transform="translate(977 941)" fill="#fff" font-size="19" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-35.954" y="0">CANCEL</tspan></text>
          </g>
        </g>
      </g>
      <g id="CheckBox_Details" data-name="CheckBox Details" transform="translate(32 30)">
        <text id="I_have_read_and_I_accept_Virtual_Robot_non-disclosure_agreement_NDA_and_Code_of_Conduct." data-name="I have read and I accept Virtual Robot non-disclosure agreement (NDA) and Code of Conduct." transform="translate(1130 833)" font-size="15" font-family="SegoeUI, Segoe UI"><tspan x="-309.694" y="0">I have read and I accept Virtual Robot non-disclosure agreement (NDA) and </tspan><tspan y="0" fill="#f9a01b" text-decoration="underline">Code of Conduct</tspan><tspan y="0">.</tspan></text>
        <g id="Rectangle_33" data-name="Rectangle 33" transform="translate(773 814)" fill="#fff" stroke="#707070" stroke-width="1">
        ...
        <g id="Menu" transform="translate(35)">
          <g id="Beta" transform="translate(0 200.05)">
            <g transform="matrix(1, 0, 0, 1, 10, -200.05)" filter="url(#BG)">
              <rect id="BG-2" data-name="BG" width="281" height="91.901" rx="25" transform="translate(379 793.05)" fill="url(#linear-gradient-3)"/>
            </g>
...
<script>
    ...
    function Join() {
        location.replace("BetaMember.aspx")
    }
    function Back() {
