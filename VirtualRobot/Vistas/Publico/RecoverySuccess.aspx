<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Login.Master" AutoEventWireup="true" CodeBehind="RecoverySuccess.aspx.cs" Inherits="VirtualRobot.Vistas.Publico.RecoverySuccess" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <defs>
    ...
    <filter id="Path_2" x="879.5" y="595.5" width="161.775" height="59.687" filterUnits="userSpaceOnUse">
    ...
    <filter id="OllieLogo" x="812.5" y="87.5" width="294.408" height="187.786" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <clipPath id="clip-Info_Recovery_Msg_Reset">
      <rect width="1920" height="1080"/>
    </clipPath>
  </defs>
  <g id="Info_Recovery_Msg_Reset" data-name="Info Recovery Msg Reset" clip-path="url(#clip-Info_Recovery_Msg_Reset)">
    ...
    <g id="Continue_Btm" data-name="Continue Btm" transform="translate(884 598)" onclick="Home()" style="cursor:pointer">
      <g transform="matrix(1, 0, 0, 1, -884, -598)" filter="url(#Path_2)">
        <g id="Path_2-2" data-name="Path 2" transform="translate(884 598)" fill="url(#linear-gradient)">
    ...
    <text id="YAY_We_found_your_credentials_and_we_will_send_you_an_email_with_the_instructions_so_you_can_get_back_in._" data-name="YAY! We found your credentials and we will send you an email  with the instructions so you can get back in. " transform="translate(960 426)" fill="#454545" font-size="25" font-family="SegoeUI, Segoe UI"><tspan x="-343.89" y="0" id="YAY">YAY! We found your credentials and we will send you an email </tspan><tspan x="-244.757" y="33" id="with">with the instructions so you can get back in. </tspan></text>
    ...
    function Idioma() {
        ...
        if (idioma == null) {
            ...
            if (idioma == "Español") {
                ...
                document.getElementById("YAY").innerHTML = "YAY! Encontramos tus credenciales y te enviaremos un correo";
                document.getElementById("with").innerHTML = "con las instrucciones para que puedas volver";
            } else {
                document.getElementById("Ho").innerHTML = "Home";
                document.getElementById("YAY").innerHTML = "YAY! We found your credentials and we will send you an email";
                document.getElementById("with").innerHTML = "with the instructions so you can get back in.";
            }
        }
    }
    function English() {
