<%@ Page Title="" Language="C#" Async="true" MasterPageFile="~/Masters/Login.Master" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="VirtualRobot.Vistas.Publico.Registro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%; margin-left: auto; margin-right: auto; text-align: center; background-color:white">
        <tr>
            <td style="width: 440px">
                <asp:Image ID="Image3" runat="server" Width="150px" Height="100px" src="/../Imagenes/LogoP.png"/>
            </td>
            <td>
                <div>
                    <p>Äarika Citizenship</p>
                </div>
                <div>
            ...
            <td>
                <asp:Image ID="Image2" runat="server" Width="100px" Height="100px" src="/../Imagenes/Logo.png"/>
            </td>
        </tr>        
    </table>
    <div style="width:100%; margin-left: auto; margin-right: auto; text-align: center;">
        <asp:Label ID="Label2" runat="server" Text="Label">Fill the following form to get your Äarika citizenship credentials</asp:Label>
        <br/>
        <asp:Label ID="Label5" runat="server" Text="Label">Username ID</asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox1" runat="server" Placeholder="4-8 Characters"></asp:TextBox>
        <br/>
        <asp:Label ID="Label6" runat="server" Text="Label">E-mail address</asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox2" runat="server" Placeholder="E-mail address" ></asp:TextBox>
        <br/>
        <asp:Label ID="Label7" runat="server" Text="Label">Password</asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox3" runat="server" Placeholder="6 Characters or more"></asp:TextBox>
        <br/>
        <asp:Label ID="Label8" runat="server" Text="Label">Confirm Password</asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox4" runat="server" Placeholder="6 Characters or more"></asp:TextBox>
        <br/>
        <asp:Label ID="Label9" runat="server" Text="Label">Date of birth</asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox5" runat="server" type="date"></asp:TextBox>
        <br/>
        <asp:Label ID="Label10" runat="server" Text="Label">Country/region of residence</asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="col-xs-offset-0">
        ...
        <br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label11" runat="server" Text="Label">Time zone</asp:Label>
        ...
        <asp:Label ID="Label3" runat="server" Text="Label">     I'd like to receive special offers, game news, and more</asp:Label>
        <br/>
        <asp:CheckBox ID="CheckBox2" runat="server"/>
        <asp:Label ID="Label1" runat="server" Text="Label">     I agree to the </asp:Label><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="/../Documentos/English/Virtual Robot Account User Agreement.pdf" target="_blank">Virtual Robot Account User Agreement</asp:HyperLink><asp:Label ID="Label4" runat="server" Text="Label"> and I acknowledge that I have read the</asp:Label><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="/../Documentos/English/Virtual Robot Privacy Policy.pdf" target="_blank">Virtual Robot Privacy Policy</asp:HyperLink>
        <br/>
        ...
        <asp:Button ID="Button1" runat="server" Text="Button" OnClick="Button1_Click" /> <asp:Button ID="Button2" runat="server" Text="Submit" OnClick="Button2_Click" />
    </div>
</asp:Content>
