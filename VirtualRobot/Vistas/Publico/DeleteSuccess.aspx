<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Login.Master" AutoEventWireup="true" CodeBehind="DeleteSuccess.aspx.cs" Inherits="VirtualRobot.Vistas.Publico.DeleteSuccess" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 1080">
  <defs>
    <filter id="Rectangle_14" x="475" y="51.387" width="970.336" height="943.782" filterUnits="userSpaceOnUse">
    ...
    <filter id="LogoVR" x="895" y="865.769" width="130.315" height="88.519" filterUnits="userSpaceOnUse">
    ...
    <linearGradient id="linear-gradient" x1="0.5" y1="1.187" x2="0.5" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color="#5cd4ff"/>
      <stop offset="1" stop-color="#5684e0"/>
    </linearGradient>
    <filter id="Path_2" x="879.5" y="755.5" width="161.774" height="59.687" filterUnits="userSpaceOnUse">
    ...
    <filter id="OllieLogo" x="812.5" y="87.5" width="294.407" height="187.785" filterUnits="userSpaceOnUse">
      <feOffset dy="3" input="SourceAlpha"/>
    ...
    <clipPath id="clip-Account_Deleted_Recovery_time">
      <rect width="1920" height="1080"/>
    </clipPath>
  </defs>
  <g id="Account_Deleted_Recovery_time" data-name="Account Deleted Recovery time" clip-path="url(#clip-Account_Deleted_Recovery_time)">
    <rect width="1920" height="1080" fill="#fff"/>
    <rect id="Rectangle_5" data-name="Rectangle 5" width="1920" height="1080" fill="#f5f5f5"/>
    <g id="FormBG" transform="translate(0.375)">
      <g transform="matrix(1, 0, 0, 1, -0.38, 0)" filter="url(#Rectangle_14)">
        <rect id="Rectangle_14-2" data-name="Rectangle 14" width="952.336" height="925.782" rx="25" transform="translate(484 57.39)" fill="#fff"/>
      </g>
    ...
    <text id="You_can_reactivate_your_account_by_attempting_to_sign_in_during_the_next_15_days._The_account_will_be_deleted_permanently_after_the_deactivation_period_passes._To_reactivate_an_account_that_has_been_set_for_deletion_you_need_the_password_and_e-mail_addre" data-name="You can reactivate your account by attempting to sign in during the next 15 days. The account will be deleted permanently after the deactivation period passes.  To reactivate an account that has been set for deletion, you need the password and e-mail addre" transform="translate(543 523)" fill="#454545" font-size="17" font-family="SegoeUI, Segoe UI"><tspan x="0" y="18" id="You">You can reactivate your account by attempting to sign in during the next 15 days. The account will be deleted </tspan><tspan x="0" y="40" id="permanently">permanently after the deactivation period passes.</tspan><tspan x="0" y="62"/><tspan x="0" y="84" id="To">To reactivate an account that has been set for deletion, you need the password and e-mail address you use to </tspan><tspan x="0" y="106" id="sign">sign in to your account.</tspan><tspan x="0" y="128"/><tspan x="0" y="150" id="If">If you choose to reactivate an account during the deactivation period, we cannot guarantee that all of the data </tspan><tspan x="0" y="172" id="will">will be recovered.</tspan></text>
    <text id="So_sad_to_see_you_leave_ಥ_ಥ_Your_account_has_now_been_deactivated_" data-name="So sad to see you leave (ಥ﹏ಥ)   Your account has now been deactivated  " transform="translate(960 396)" fill="#454545" font-size="40" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="-295.801" y="0" id="So">So sad to see you leave (</tspan><tspan y="0" font-family="NirmalaUI-Bold, Nirmala UI">ಥ</tspan><tspan y="0" font-family="MicrosoftJhengHeiUIBold, Microsoft JhengHei UI" font-weight="400">﹏</tspan><tspan y="0" font-family="NirmalaUI-Bold, Nirmala UI">ಥ</tspan><tspan y="0">)</tspan><tspan font-size="25"><tspan x="-3.448" y="37"> </tspan><tspan x="-239.148" y="70" id="Your">Your account has now been deactivated </tspan><tspan y="70" font-family="SegoeUI, Segoe UI" font-weight="400"> </tspan></tspan></text>
    <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#LogoVR)">
      <image id="LogoVR-2" data-name="LogoVR" width="124.315" height="82.518" transform="translate(898 867.77)" xlink:href="/../Imagenes/Logo.png"/>
    </g>
    <g id="Home_Btm" data-name="Home Btm" transform="translate(884 758)" onclick="Home()" style="cursor:pointer">
      <g transform="matrix(1, 0, 0, 1, -884, -758)" filter="url(#Path_2)">
        <g id="Path_2-2" data-name="Path 2" transform="translate(884 758)" fill="url(#linear-gradient)">
...
<script>
    ...
    function Idioma() {
        ...
        if (idioma == null) {
            ...
            if (idioma == "Español") {
                document.getElementById("So").innerHTML = "Que triste verte ir (";
                document.getElementById("Your").innerHTML = "Tu cuenta ha sido desactivada"; 
                document.getElementById("You").innerHTML = "Puedes reactivar tu cuenta logeandote dentro de los proximos 15 dias. Tu cuenta sera borrada";
                document.getElementById("permanently").innerHTML = "permanentemente despues de que el periodo pase";
                document.getElementById("To").innerHTML = "Para reactivar la cuenta necesitas la contraseña y el email que usaste para";
                document.getElementById("sign").innerHTML = "logearte en tu cuenta";
                document.getElementById("If").innerHTML = "Si eliges reactivar una cuenta durante el periodo de desactivacion no podemos garantizar que recuperes";
                document.getElementById("will").innerHTML = "todos los datos";
                document.getElementById("Ho").innerHTML = "Volver";
            } else {
                document.getElementById("So").innerHTML = "So sad to see you leave (";
                document.getElementById("Your").innerHTML = "Your account has now been deactivated"; 
                document.getElementById("You").innerHTML = "You can reactivate your account by attempting to sign in during the next 15 days. The account will be deleted ";
                document.getElementById("permanently").innerHTML = "permanently after the deactivation period passes.";
                document.getElementById("To").innerHTML = "To reactivate an account that has been set for deletion, you need the password and e-mail address you use to ";
                document.getElementById("sign").innerHTML = "sign in to your account.";
                document.getElementById("If").innerHTML = "If you choose to reactivate an account during the deactivation period, we cannot guarantee that all of the data";
                document.getElementById("will").innerHTML = "will be recovered.";
                document.getElementById("Ho").innerHTML = "Home";
            }
        }
    }
    function English() {
